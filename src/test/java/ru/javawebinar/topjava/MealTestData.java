...
public class MealTestData {
    ...
    public static final Meal REST_MEAL = new Meal(null, of(2016, Month.OCTOBER, 24, 5, 0), "Ужин", 510);
    ...
    public static final List<MealWithExceed> MEALS_WITH_EXCEED = getWithExceeded(MEALS, DEFAULT_CALORIES_PER_DAY);
    public static final List<MealWithExceed> HALF_MEAL_WITH_EXCEED = MEALS_WITH_EXCEED.subList(0, 3);
    public static final MealWithExceed MEAL_WITH_EXCEED = MEALS_WITH_EXCEED.get(0);
    public static final int MEAL_WITH_EXCEED_ID = MEAL_WITH_EXCEED.getId();
