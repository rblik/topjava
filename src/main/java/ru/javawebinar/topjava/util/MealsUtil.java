...
public class MealsUtil {
    public static final List<Meal> MEALS = Arrays.asList(
            ...
            new Meal(LocalDateTime.of(2015, Month.JUNE, 5, 9, 0), "Завтрак", 800, 2),
            new Meal(LocalDateTime.of(2015, Month.JUNE, 5, 14, 0), "Обед", 800, 2),
            new Meal(LocalDateTime.of(2015, Month.JUNE, 5, 21, 0), "Ужин", 500, 2),
            new Meal(LocalDateTime.of(2015, Month.JUNE, 6, 9, 0), "Завтрак", 300, 2),
            new Meal(LocalDateTime.of(2015, Month.JUNE, 6, 14, 0), "Обед", 700, 2),
            new Meal(LocalDateTime.of(2015, Month.JUNE, 6, 21, 0), "Ужин", 600, 2)
    );
